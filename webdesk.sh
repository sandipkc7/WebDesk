...
" 2>/dev/null || true
    ...
    echo -e "             • All users share & see the exact same desktop simultaneously."
    echo -e "             • Works on Physical screens, RustDesk/NoMachine, and Headless VPS.\n"
    ...
    echo -e "    ${YELLOW}${BOLD}Mode 3)${NC} 👥 ${BOLD}Independent Multi-User Workstation${NC}"
    echo -e "             • Multiple Linux users work simultaneously on separate virtual desktops."
